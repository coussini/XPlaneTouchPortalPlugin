...
def main(): 
    ...
    json_data_init = {
        ...
        'datarefs': [
            {
                'dataref': 'C3_AirbusFBW/OHPLightSwitches[7]', # Strobe  -> int
                'value':   '2' # Strobe  -> int
            },
            {
                'dataref': 'C3_AirbusFBW/RMP3Lights[0]', # OVHD INTEG LT Brightness Knob -> float
                'value':   '0.50' # OVHD INTEG LT Brightness Knob -> float
            },
            {
                'dataref': 'C3_AirbusFBW/APUStarter', # APU Start -> int
